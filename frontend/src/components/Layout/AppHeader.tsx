...
import { IconDatabase, IconFolders, IconFiles, IconMoon, IconSun, IconTag, IconTimeline, IconCalendarEvent, IconChartBar } from '@tabler/icons-react'
...
const NAV_ITEMS = [
  ...
  { to: '/statistics', label: 'Statistics', icon: IconChartBar, end: false },
]
